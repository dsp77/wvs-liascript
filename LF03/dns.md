...
Neben IP-Adresse mit Subnetzmaske und Gateway-Adresse gehört der DNS-Server zur Grundkonfiguration eines Endgerätes.
...
Zur Absicherung kann ein weiterer DNS-Server konfiguriert werden, der bei nicht Erreichbarkeit des ersten verwendet wird.
